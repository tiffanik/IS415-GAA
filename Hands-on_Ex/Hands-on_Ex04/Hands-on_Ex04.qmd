...
-   if the answer is not, then the next logical question is where are the locations with higher concentration of childcare centres? Installing and Loading the R packages
...
# 4.3 Importing the spatial data
...
tm_shape(childcare_sf) +
  tm_dots(alph=0.5, # intensity of color
          size=0.01) + 
  tm_view(
  set.zoom.limits= c(11,14)) # set zoom limits
```
